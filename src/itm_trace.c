 ...
 *      Author: chris
 *
 *  Based on work by Petteri Aimonen
 *  see https://github.com/PetteriAimonen/STM32_Trace_Example
 *  and
...
//
//
////https://github.com/ErichStyger/mcuoneclipse/blob/master/Examples/KDS/TWR-K64F120M/TWR-K64F120M_Demo/Sources/swo.c
//
//
...
//    }
    ...
    TPI->FFCR = 0x100; // 0x102; // TPIU packet framing enabled when bit 2 is set.
